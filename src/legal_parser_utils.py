...
# TODO: Find better way to link to documents
def parse_legal_texts(gdpr_path=None, dga_path=None):
    '''
    ...
    if gdpr_path is None:
        gdpr_path = "../../datasets/gdpr/gdpr.html"
    
    if dga_path is None:
        dga_path = "../../datasets/dga/dga.html"
